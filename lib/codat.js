...
export async function getDataStatus() {
  ...
  console.log(dataStatusUrl);
  try {
    var { data } = await axios.post(dataStatusUrl, {
      headers: {
        accept: "*/*",
        Authorization: process.env.CODAT_BASIC_AUTH,
      },
...
export async function getBillsCodat() {
  const companyBillUrl = `${codatPreUrl}/companies/${companyCodatId}/data/bills?page=1&pageSize=250&orderBy=-issueDate`;
