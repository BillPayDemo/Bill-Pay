...
export async function getBillsCodat(companyId, pageSize, pageNumber) {
  const companyBillUrl = `${codatPreUrl}/companies/${companyId}/data/bills?page=${pageNumber}&pageSize=${pageSize}&orderBy=-issueDate`;
